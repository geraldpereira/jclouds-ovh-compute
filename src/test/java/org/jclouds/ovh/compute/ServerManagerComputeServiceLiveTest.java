...
public class ServerManagerComputeServiceLiveTest extends BaseComputeServiceLiveTest {
   ...
   protected Properties setupRestProperties() {
      ...
      restProperties.setProperty("ovh.contextbuilder",
            OVHComputeServiceContextBuilder.class.getName());
   ...
   public void testAssignability() throws Exception {
      ...
      RestContext<OVHComputeClient, OVHComputeClient> goGridContext = new ComputeServiceContextFactory().createContext(
